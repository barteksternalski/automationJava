...
public class reporter extends listener {
    private static final Logger L = Logger.getLogger(listener.class);
    static String locale = System.getProperty("env");
    ...
    String getTime() {
        Date date = new Date();
        return date.toString().substring(11, 13) + ":" + date.toString().substring(14, 16) + ":" + date.toString().substring(17, 19);
    }
    ...
    protected PrintWriter createWriter(String outdir) throws IOException {
        ...
        return new PrintWriter(new BufferedWriter(new OutputStreamWriter(new FileOutputStream("target/surefire-reports/mlInfAPI.html"), StandardCharsets.UTF_8)));
    }
        ...
        if (tests.getAllResults().size() > 0) {
            ...
            for (ITestNGMethod method : getMethodSet(tests, suite)) {
                ...
                String testInstanceName = resultSet
                        .toArray(new ITestResult[resultSet.size()])[0].getTestName();
    ...
    private void startResultSummaryTable(String style) {
        ...
        m_out.println("<tr><th>Class</th>" + "<th>Method</th><th># of Scenarios</th><th>Time (ms)</th></tr>");
        m_row = 0;
    }
    ...
    public void generateSuiteSummaryReport(List<ISuite> suites) {
        m_out.println("<p>Test results for: <b>" + locale.toUpperCase() + "</b></p><p>.</p>");
        tableStart("testOverview", null);
        m_out.print("<tr>");
        tableColumnStart("Test");
        tableColumnStart("Methods Passed");
    ...
    protected void startHtml(PrintWriter out) {
        ...
        out.println("<head>");
        out.println("<title>Report for: " + locale + "</title>");
        ...
        out.println(".passedodd td {background-color: #00aa00}");
        out.println(".passedeven td {background-color: #33ff33}");
        out.println(".skippedodd td {background-color: #ccc000}");
        out.println(".skippedodd td {background-color: #ddd000}");
        out.println(".failedodd td,.numi_attn {background-color: #ff3333}");
        out.println(".failedeven td,.stripe .numi_attn {background-color: #d00000}");
        out.println(".stacktrace {white-space:pre;font-family:monospace}");
        out.println(".totop {font-size:85%;text-align:center;border-bottom:2px solid #000000}");
        out.println("</style>");
        out.println("</head>");
        out.println("<body>");
    }
