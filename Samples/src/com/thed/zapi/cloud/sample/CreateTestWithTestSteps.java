...
public class CreateTestWithTestSteps {
	...
	private static String jiraBaseURL = "https://worldremit.atlassian.net";
	...
	static String accessKey = "amlyYTpkNDI5MjdmMS0wYjIzLTQxZDYtOWM4Ny03NjhmYjQ3YzJmYzQgNWMwNTQwYmI1NWM3N2M1MDkxMjJmYjQ1IEJhcnQ";
	// zephyr secretKey , we can get from Addons >> zapi section
	static String secretKey = "1tv7TMtiG37jf7yCh3Ci-IBSJCfcnP6RuyXBKj31F20";

	/** Declare parameter values here */

	private static String userName = "bsternalski";
	private static String accountId = "bsternalski@worldremit.com";
	private static String password = "password";
	private static String projectId = "15570";
	private static String issueTypeId = "10000";
