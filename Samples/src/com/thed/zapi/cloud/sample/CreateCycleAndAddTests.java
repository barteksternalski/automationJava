...
import generator.java.src.main.java.com.thed.zephyr.cloud.rest.exception.JobProgressException;
...
public class CreateCycleAndAddTests {
	...
	public static void main(String[] args) throws URISyntaxException, JobProgressException, JSONException, IllegalStateException, IOException {
		...
		String accountId = "bsternalski@worldremit.com";
		ZFJCloudRestClient client = ZFJCloudRestClient.restBuilder(zephyrBaseUrl, accessKey, secretKey, accountId)
				.build();

		/** Declare the Variables here **/
		String projectId = "15502";
		String versionId = "32173";
		String cycleName = "Test Cycle - zapi new";
		String cycleDescription = "Created by @Bart";
		...
		String[] issueIds = { "123", "234" }; //Issue Id's to be added to Test Cycle, add more issueKeys separated by comma
